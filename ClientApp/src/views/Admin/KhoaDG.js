...
class AdminDG extends Component {
    ...
    update() {
        ...
        let { masodanhgia, manamhoc, mavienchuc, ykienkhoa, khoa, ngaybmdg, ngaykhoadg } = this.state.editData;
        axios.put('/danhgias/admin/' + this.state.editData.masodanhgia,
            { masodanhgia, manamhoc, mavienchuc, ykienkhoa, khoa, ngaybmdg, ngaykhoadg }).then((response) => {
